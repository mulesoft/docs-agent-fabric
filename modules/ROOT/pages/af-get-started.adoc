...
* Use the permission tables in each job section together with your internal access guide. For the enhanced experience permissions table, see xref:general::exp-home-start.adoc#permissions[Enhanced Experience Permissions].
...
Learn more: xref:general::exp-portfolio-overview.adoc[] and xref:general::exp-services-add-to-portfolio.adoc[].
...
* Provider-specific credentials, roles, and permission scopes for that scanner. For example, writing policies to a third-party gateway requires connection credentials that carry the provider's write scope, and the Microsoft Copilot Studio scanner can require a pre-configured OAuth app. See xref:general::exp-scanners-prerequisites-reference.adoc[].
...
Learn more: xref:general::exp-scanners-add-from-providers.adoc[] and xref:general::exp-providers-manage.adoc[].
...
Learn more: xref:general::exp-services-create-mcp-server.adoc[] and xref:af-use-case-mcp-bridge.adoc[].
...
Learn more: xref:general::exp-services-create-a2a-bridge.adoc[].
...
* A connected provider scanner whose credentials carry the provider's write scope, required to apply policies to third-party gateway APIs (Azure API Management, Google Apigee, or Kong Gateway). See xref:general::exp-scanners-prerequisites-reference.adoc#_policy_write_prerequisites[Policy Write Prerequisites].
...
Learn more: xref:general::exp-instances-add.adoc[], xref:general::exp-policies-apply-manage.adoc[], and xref:general::exp-policies-universal.adoc[].
...
Learn more: xref:general::exp-governance-work-with-strategies.adoc[], xref:general::exp-governance-govern-third-party-apis.adoc[], and xref:general::exp-governance-monitor-cross-gateway-conformance.adoc[].
...
* A configured semantic routing service if you want to use semantic routing. See xref:general::model-proxy-semantic-service.adoc[].
* A configured semantic caching service if you want to enable semantic caching. See xref:general::model-proxy-semantic-caching-service.adoc[].
...
Learn more: xref:general::model-proxy.adoc[] and xref:general::model-proxy-create-model-proxy.adoc[].
...
Learn more: xref:general::exp-governance-view-cost-and-token-usage.adoc[], xref:general::exp-model-wallets-manage.adoc[], xref:general::exp-models-manage-costs.adoc[], and xref:af-use-case-cost-management.adoc[].
...
Learn more: xref:general::model-proxy-semantic-service.adoc[] and xref:general::model-proxy-semantic-caching-service.adoc[].
...
Learn more: xref:general::exp-detect-and-contain-rogue-agents.adoc[].
...
Learn more: xref:general::exp-vaults-manage.adoc[].
...
Learn more: xref:general::exp-akamai-risk-correlation.adoc[].
...
Learn more: xref:agent-visualizer::index.adoc[Agent Visualizer], xref:general::exp-services-monitoring.adoc[], and xref:general::exp-alerts-configure-notifications.adoc[].
