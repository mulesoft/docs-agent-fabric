...
Define your ‌agent network in a simple, human-readable YAML file, abstracting away the underlying technical complexities. This approach allows you to focus on the business constraints and context of your agenticprocess without needing to understand the inner workings of the orchestration engine.
