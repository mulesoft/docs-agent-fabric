...
Learn more: xref:general::exp-portfolio-overview.adoc[]
...
Learn more: xref:general::exp-scanners-add-from-providers.adoc[]
...
Learn more: xref:general::exp-services-create-mcp-server.adoc[]
...
Learn more: xref:general::exp-services-monitoring.adoc[] and xref:general::exp-alerts-configure-notifications.adoc[]
...
Learn more: xref:general::exp-instances-add.adoc[] and xref:general::exp-policies-apply-manage.adoc[]
...
Learn more: xref:general::exp-governance-work-with-strategies.adoc[]
...
Learn more: xref:general::exp-policies-universal.adoc[]
...
Learn more: xref:general::exp-governance-govern-third-party-apis.adoc[] and xref:general::exp-governance-monitor-cross-gateway-conformance.adoc[]
...
* Detect and contain rogue agents: Apply Rogue Agent Detection and Agent Kill Switch policies to each model proxy you want to protect. Detection flags risky behavior for your review. The Kill Switch policy blocks that agent's access to the model proxy when you quarantine it. Quarantine always requires your review, and you reverse it if needed. Learn more: xref:general::exp-detect-and-contain-rogue-agents.adoc[]
* External vaults: Register an external vault so credentials stay in AWS Secrets Manager, Azure Key Vault, or HashiCorp Vault. Only metadata is stored (zero-copy). Learn more: xref:general::exp-vaults-manage.adoc[]
* Akamai risk correlation: Correlate security findings to APIs and MCP services you've already discovered, so you can triage risk before it becomes an incident. Learn more: xref:general::exp-akamai-risk-correlation.adoc[]
...
Learn more: xref:general::model-proxy.adoc[], xref:general::model-proxy-semantic-service.adoc[], and xref:general::model-proxy-semantic-caching-service.adoc[]
...
Learn more: xref:general::exp-governance-view-cost-and-token-usage.adoc[]
...
* For a guided path through the registry, agent actions, governance, and cost control, get started with the xref:learning-map-agent-fabric.adoc[Agent Fabric learning map].

* For the technical foundations and capability pillars, explore the https://www.mulesoft.com/lp/ebook/mulesoft-agent-fabric-technical-overview[Agent Fabric Technical Overview].

* For architecture and orchestration design patterns, see the https://architect.salesforce.com/docs/architect/fundamentals/guide/mulesoft-agent-fabric-deep-dive.html#Agent_Orchestration_Design_Patterns[Agent Fabric Deep Dive].
